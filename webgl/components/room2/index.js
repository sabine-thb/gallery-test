...
export default class Room2 {
    ...
    //         { pos: [roomPosition.x - width/2, height/2, roomPosition.z], rot: [0, 0, 0], size: [width/3, height, wallThickness] },
    //         { pos: [roomPosition.x + width/2, height/2, roomPosition.z], rot: [0, 0, 0], size: [width/3, height, wallThickness] },
    //         // Autres murs
    //         { pos: [roomPosition.x, height/2, roomPosition.z + depth/2], rot: [0, Math.PI, 0], size: [width, height, wallThickness] },
